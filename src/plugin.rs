use crate::{
    expr::{function::{self, FunctionBuilder}, StaticExpr}, AssetRegistry, ComponentsData, Depends, LoadScript, Register, Registry, Scope, ScopeData, ScriptBundle, ScriptComponent, ScriptState, ScriptsReady
};
use bevy::{
    app::{Plugin, Update}, asset::{AssetServer, Assets}, ecs::{component::Component, entity::Entity, event::{EventReader, EventWriter}, query::{Changed, With}, schedule::{NextState, State}, system::{Commands, Query, Res, ResMut}}, prelude::App
};
